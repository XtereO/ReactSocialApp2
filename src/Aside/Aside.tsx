    ...
    return<div className="Aside">
        <ul className="list-group" >
            ...
            <li className="list-group-item">
                ...
                Dialogs
                <div className="right">
                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className="bi bi-chat" viewBox="0 0 16 16">
            ...
            <li className="list-group-item">
                <NavLink to="/Audio" className="Link" activeClassName="LinkActive">
                    Audio
                    <div className="right">
                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className="bi bi-music-note-beamed" viewBox="0 0 16 16">
            ...
            <li className="list-group-item">
                <NavLink to="/Video" className="Link" activeClassName="LinkActive">
                    Video
                    <div className="right">
                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className="bi bi-camera-video" viewBox="0 0 16 16">
            ...
            <li className="list-group-item">
                <NavLink to="/Photo" className="Link" activeClassName="LinkActive">
                    Photo
                    <div className="right">
                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className="bi bi-images" viewBox="0 0 16 16">
